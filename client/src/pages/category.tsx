...
export default function Category() {
  ...
  return (
    <>
      <Helmet>
        <title>{category?.name || 'Category'} - CloudCodeCraft</title>
        <meta 
          name="description" 
          content={`Browse articles about ${category?.name || 'cloud computing'} on CloudCodeCraft. Tutorials, guides, and best practices.`} 
        />
      </Helmet>
