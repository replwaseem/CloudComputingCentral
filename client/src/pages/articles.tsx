...
export default function Articles() {
  ...
  const limit = 8; // Articles per page

  const { data, isLoading } = useQuery({
    queryKey: ['/api/articles', page, limit, sortBy],
  ...
  return (
    <>
      <Helmet>
        <title>Articles - CloudCodeCraft</title>
        <meta name="description" content="Browse all articles about cloud computing with AWS, Python, and NodeJS on CloudCodeCraft." />
      </Helmet>
            ...
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="flex">
                <Button 
                  ...
                  className={sortBy === 'recent' ? 'bg-primary-500 text-white' : 'bg-white text-gray-700 border-gray-300 dark:bg-gray-700 dark:text-white dark:border-gray-600'} 
                ...
                <Button 
                  ...
                  className={`ml-2 ${sortBy === 'popular' ? 'bg-primary-500 text-white' : 'bg-white text-gray-700 border-gray-300 dark:bg-gray-700 dark:text-white dark:border-gray-600'}`}
